  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between relative z-10">
        ...
        {headerExtra || <MoreHorizontal className="text-slate-500 cursor-pointer hover:text-white transition-colors" />}
      </div>
...
function SideCard({ icon, title, sub, value, status, statusColor }: { icon: React.ReactNode, title: string, sub: string, value: string, status: string, statusColor: string }) {
  return (
    <div className="glass-panel rounded-2xl p-5 flex-1 flex items-center gap-4 hover:bg-white/5 transition-all cursor-pointer group">
      <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center border border-white/10 group-hover:border-primary/50 transition-all">
        {icon}
      </div>
      <div>
        ...
        <main className="flex-1 p-6 lg:p-10 max-w-[1600px] mx-auto w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            <DashboardCard
              ...
              accentColor="primary"
              bgIcon={<Plane className="w-24 h-24" />}
            >
            ...
            <DashboardCard
              ...
              accentColor="green"
              headerExtra={<RefreshCw className="text-green-500 animate-spin w-4 h-4" style={{ animationDuration: '4s' }} />}
            >
          ...
          <div className="mt-12">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-bold text-white flex items-center gap-2">
                <Network className="text-primary w-6 h-6" /> Global Traffic Matrix
              </h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col gap-4">
                ...
                />
                <SideCard
                  icon={<ShieldCheck className="text-accent-blue w-6 h-6" />}
                  ...
                  statusColor="text-green-500"
                />
                <div className="glass-panel-heavy rounded-2xl p-5 flex-1 flex items-center gap-4 border border-primary/20 shadow-xl">
